...
var ReactThirteenAdapter = function (_EnzymeAdapter) {
  ...
  function ReactThirteenAdapter() {
    ...
    var _this2 = _possibleConstructorReturn(this, (ReactThirteenAdapter.__proto__ || Object.getPrototypeOf(ReactThirteenAdapter)).call(this));
          ...
          render: function () {
            function render(el, context) {
              if (options.context && (el.type.contextTypes || options.childContextTypes)) {
                ...
                return _react2['default'].renderToStaticMarkup(_react2['default'].createElement(ContextWrapper));
              }
